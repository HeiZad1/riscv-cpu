...
VL_ATTR_COLD void VaxiTop___024root___ctor_var_reset(VaxiTop___024root* vlSelf) {
    ...
    vlSelf->__pinNumber11 = VL_RAND_RESET_I(1);
    vlSelf->axiTop__DOT__s2m_WREADY = VL_RAND_RESET_I(1);
    vlSelf->axiTop__DOT__AWPROT = VL_RAND_RESET_I(4);
    ...
    vlSelf->axiTop__DOT__cpu2axi__DOT__r_WREADY = VL_RAND_RESET_I(1);
    ...
    vlSelf->axiTop__DOT__axi2mem__DOT__r_ARVALID = VL_RAND_RESET_I(1);
    vlSelf->axiTop__DOT__axi2mem__DOT__r_WDATA = VL_RAND_RESET_I(32);
    ...
    vlSelf->axiTop__DOT__axi2mem__DOT__r_AWADDR = VL_RAND_RESET_I(32);
